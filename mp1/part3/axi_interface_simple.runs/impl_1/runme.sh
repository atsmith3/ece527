...
HD_PWD='/home/andrew/ece527/mp1/part3/axi_interface_simple.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_switch_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_switch_wrapper.tcl -notrace
