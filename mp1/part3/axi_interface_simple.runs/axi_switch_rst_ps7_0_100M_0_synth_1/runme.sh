...
HD_PWD='/home/andrew/ece527/mp1/part3/axi_interface_simple.runs/axi_switch_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_switch_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_switch_rst_ps7_0_100M_0.tcl
