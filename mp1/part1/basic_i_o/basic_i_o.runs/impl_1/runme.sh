...
HD_PWD='/home/andrew/ece527/mp1/part1/basic_i_o/basic_i_o.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basic_i_o.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basic_i_o.tcl -notrace
