...
HD_PWD='/home/andrew/ece527/mp1/part1/basic_i_o/basic_i_o.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basic_i_o.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basic_i_o.tcl
