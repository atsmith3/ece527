...
#ifndef __lenet_wrapper_fcmdEe__HH__
#define __lenet_wrapper_fcmdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet_wrapper_fcmdEe) {
    ...
    SC_CTOR(lenet_wrapper_fcmdEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
