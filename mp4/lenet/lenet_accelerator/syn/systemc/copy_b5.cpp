...
const sc_logic copy_b5::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic copy_b5::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<9> copy_b5::ap_ST_fsm_state1 = "1";
const sc_lv<9> copy_b5::ap_ST_fsm_state2 = "10";
const sc_lv<9> copy_b5::ap_ST_fsm_state3 = "100";
const sc_lv<9> copy_b5::ap_ST_fsm_state4 = "1000";
const sc_lv<9> copy_b5::ap_ST_fsm_state5 = "10000";
const sc_lv<9> copy_b5::ap_ST_fsm_state6 = "100000";
const sc_lv<9> copy_b5::ap_ST_fsm_state7 = "1000000";
const sc_lv<9> copy_b5::ap_ST_fsm_state8 = "10000000";
const sc_lv<9> copy_b5::ap_ST_fsm_state9 = "100000000";
const sc_lv<32> copy_b5::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<1> copy_b5::ap_const_lv1_0 = "0";
const sc_lv<3> copy_b5::ap_const_lv3_0 = "000";
const sc_lv<2> copy_b5::ap_const_lv2_0 = "00";
const sc_lv<4> copy_b5::ap_const_lv4_0 = "0000";
const sc_lv<32> copy_b5::ap_const_lv32_7 = "111";
const sc_lv<7> copy_b5::ap_const_lv7_0 = "0000000";
const sc_lv<32> copy_b5::ap_const_lv32_6 = "110";
const sc_lv<32> copy_b5::ap_const_lv32_8 = "1000";
const sc_lv<32> copy_b5::ap_const_lv32_78 = "1111000";
const sc_lv<7> copy_b5::ap_const_lv7_78 = "1111000";
const sc_lv<7> copy_b5::ap_const_lv7_1 = "1";
const sc_lv<1> copy_b5::ap_const_lv1_1 = "1";
const bool copy_b5::ap_const_boolean_1 = true;

copy_b5::copy_b5(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_c5_b_i13_cast1_fu_79_p1);
    sensitive << ( c5_b_i13 );
    ...
    SC_METHOD(thread_i_13_fu_100_p2);
    sensitive << ( i_reg_68 );

    SC_METHOD(thread_i_cast1_fu_90_p1);
    sensitive << ( i_reg_68 );
    ...
    sensitive << ( ap_start );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( c5_b_i13_cast1_fu_79_p1 );
    sensitive << ( ap_reg_ioackin_m_axi_in_r_ARREADY );
    ...
    sensitive << ( in_addr_read_reg_125 );
    sensitive << ( ap_CS_fsm_state9 );
    ...
    apTFilenSS << "copy_b5_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, c5_b_i13, "(port)c5_b_i13");
    ...
    sc_trace(mVcdFile, i_cast1_fu_90_p1, "i_cast1_fu_90_p1");
    sc_trace(mVcdFile, i_cast1_reg_112, "i_cast1_reg_112");
    sc_trace(mVcdFile, ap_block_state8, "ap_block_state8");
    sc_trace(mVcdFile, i_13_fu_100_p2, "i_13_fu_100_p2");
    sc_trace(mVcdFile, i_13_reg_120, "i_13_reg_120");
    sc_trace(mVcdFile, in_addr_read_reg_125, "in_addr_read_reg_125");
    sc_trace(mVcdFile, i_reg_68, "i_reg_68");
    sc_trace(mVcdFile, ap_CS_fsm_state7, "ap_CS_fsm_state7");
    sc_trace(mVcdFile, ap_CS_fsm_state9, "ap_CS_fsm_state9");
    sc_trace(mVcdFile, c5_b_i13_cast1_fu_79_p1, "c5_b_i13_cast1_fu_79_p1");
...
void copy_b5::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        i_reg_68 = i_13_reg_120.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        i_reg_68 = ap_const_lv7_0;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && !(esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_94_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_in_r_RVALID.read())))) {
        i_13_reg_120 = i_13_fu_100_p2.read();
        i_cast1_reg_112 = i_cast1_fu_90_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_94_p2.read()) && !(esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_94_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_in_r_RVALID.read())))) {
        in_addr_read_reg_125 = m_axi_in_r_RDATA.read();
    }
}

void copy_b5::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void copy_b5::thread_ap_CS_fsm_state7() {
    ap_CS_fsm_state7 = ap_CS_fsm.read()[6];
}

void copy_b5::thread_ap_CS_fsm_state8() {
    ap_CS_fsm_state8 = ap_CS_fsm.read()[7];
}

void copy_b5::thread_ap_CS_fsm_state9() {
    ap_CS_fsm_state9 = ap_CS_fsm.read()[8];
}

void copy_b5::thread_ap_block_state8() {
    ap_block_state8 = (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_94_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_in_r_RVALID.read()));
}

void copy_b5::thread_ap_done() {
    if (((esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read())) || 
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && 
          !(esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_94_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_in_r_RVALID.read())) && 
...
void copy_b5::thread_ap_sig_ioackin_m_axi_in_r_ARREADY() {
...
void copy_b5::thread_c5_b_i13_cast1_fu_79_p1() {
    c5_b_i13_cast1_fu_79_p1 = esl_zext<32,30>(c5_b_i13.read());
}

void copy_b5::thread_exitcond_fu_94_p2() {
    exitcond_fu_94_p2 = (!i_reg_68.read().is_01() || !ap_const_lv7_78.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_68.read() == ap_const_lv7_78);
}

void copy_b5::thread_i_13_fu_100_p2() {
    i_13_fu_100_p2 = (!i_reg_68.read().is_01() || !ap_const_lv7_1.is_01())? sc_lv<7>(): (sc_biguint<7>(i_reg_68.read()) + sc_biguint<7>(ap_const_lv7_1));
}

void copy_b5::thread_i_cast1_fu_90_p1() {
    i_cast1_fu_90_p1 = esl_zext<32,7>(i_reg_68.read());
}

void copy_b5::thread_in_r_blk_n_AR() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
...
void copy_b5::thread_in_r_blk_n_R() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_94_p2.read()))) {
...
void copy_b5::thread_m_axi_in_r_ARADDR() {
    m_axi_in_r_ARADDR = c5_b_i13_cast1_fu_79_p1.read();
}

void copy_b5::thread_m_axi_in_r_ARBURST() {
    m_axi_in_r_ARBURST = ap_const_lv2_0;
}

void copy_b5::thread_m_axi_in_r_ARCACHE() {
    m_axi_in_r_ARCACHE = ap_const_lv4_0;
}

void copy_b5::thread_m_axi_in_r_ARID() {
    m_axi_in_r_ARID = ap_const_lv1_0;
}

void copy_b5::thread_m_axi_in_r_ARLEN() {
    m_axi_in_r_ARLEN = ap_const_lv32_78;
}

void copy_b5::thread_m_axi_in_r_ARLOCK() {
    m_axi_in_r_ARLOCK = ap_const_lv2_0;
}

void copy_b5::thread_m_axi_in_r_ARPROT() {
    m_axi_in_r_ARPROT = ap_const_lv3_0;
}

void copy_b5::thread_m_axi_in_r_ARQOS() {
    m_axi_in_r_ARQOS = ap_const_lv4_0;
}

void copy_b5::thread_m_axi_in_r_ARREGION() {
    m_axi_in_r_ARREGION = ap_const_lv4_0;
}

void copy_b5::thread_m_axi_in_r_ARSIZE() {
    m_axi_in_r_ARSIZE = ap_const_lv3_0;
}

void copy_b5::thread_m_axi_in_r_ARUSER() {
    m_axi_in_r_ARUSER = ap_const_lv1_0;
}

void copy_b5::thread_m_axi_in_r_ARVALID() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && 
...
void copy_b5::thread_m_axi_in_r_AWADDR() {
    m_axi_in_r_AWADDR = ap_const_lv32_0;
}

void copy_b5::thread_m_axi_in_r_AWBURST() {
    m_axi_in_r_AWBURST = ap_const_lv2_0;
}

void copy_b5::thread_m_axi_in_r_AWCACHE() {
    m_axi_in_r_AWCACHE = ap_const_lv4_0;
}

void copy_b5::thread_m_axi_in_r_AWID() {
    m_axi_in_r_AWID = ap_const_lv1_0;
}

void copy_b5::thread_m_axi_in_r_AWLEN() {
    m_axi_in_r_AWLEN = ap_const_lv32_0;
}

void copy_b5::thread_m_axi_in_r_AWLOCK() {
    m_axi_in_r_AWLOCK = ap_const_lv2_0;
}

void copy_b5::thread_m_axi_in_r_AWPROT() {
    m_axi_in_r_AWPROT = ap_const_lv3_0;
}

void copy_b5::thread_m_axi_in_r_AWQOS() {
    m_axi_in_r_AWQOS = ap_const_lv4_0;
}

void copy_b5::thread_m_axi_in_r_AWREGION() {
    m_axi_in_r_AWREGION = ap_const_lv4_0;
}

void copy_b5::thread_m_axi_in_r_AWSIZE() {
    m_axi_in_r_AWSIZE = ap_const_lv3_0;
}

void copy_b5::thread_m_axi_in_r_AWUSER() {
    m_axi_in_r_AWUSER = ap_const_lv1_0;
}

void copy_b5::thread_m_axi_in_r_AWVALID() {
    m_axi_in_r_AWVALID = ap_const_logic_0;
}

void copy_b5::thread_m_axi_in_r_BREADY() {
    m_axi_in_r_BREADY = ap_const_logic_0;
}

void copy_b5::thread_m_axi_in_r_RREADY() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_94_p2.read()) && 
         !(esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_94_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_in_r_RVALID.read())))) {
...
void copy_b5::thread_m_axi_in_r_WDATA() {
    m_axi_in_r_WDATA = ap_const_lv32_0;
}

void copy_b5::thread_m_axi_in_r_WID() {
    m_axi_in_r_WID = ap_const_lv1_0;
}

void copy_b5::thread_m_axi_in_r_WLAST() {
    m_axi_in_r_WLAST = ap_const_logic_0;
}

void copy_b5::thread_m_axi_in_r_WSTRB() {
    m_axi_in_r_WSTRB = ap_const_lv4_0;
}

void copy_b5::thread_m_axi_in_r_WUSER() {
    m_axi_in_r_WUSER = ap_const_lv1_0;
}

void copy_b5::thread_m_axi_in_r_WVALID() {
    m_axi_in_r_WVALID = ap_const_logic_0;
}

void copy_b5::thread_out_r_address0() {
    out_r_address0 =  (sc_lv<7>) (i_cast1_reg_112.read());
}

void copy_b5::thread_out_r_ce0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
...
void copy_b5::thread_out_r_d0() {
    out_r_d0 = in_addr_read_reg_125.read();
}

void copy_b5::thread_out_r_we0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
...
void copy_b5::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 64 : 
            ...
            break;
        case 128 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && !(esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_94_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_in_r_RVALID.read())) && esl_seteq<1,1,1>(exitcond_fu_94_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_94_p2.read()) && !(esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_94_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_in_r_RVALID.read())))) {
