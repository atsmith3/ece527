...
reg    ap_block_state8;
wire   [6:0] i_13_fu_100_p2;
reg   [6:0] i_13_reg_120;
reg   [31:0] in_addr_read_reg_125;
reg   [6:0] i_reg_68;
wire    ap_CS_fsm_state7;
wire    ap_CS_fsm_state9;
wire   [31:0] c5_b_i13_cast1_fu_79_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state8) & ~((1'd0 == exitcond_fu_94_p2) & (1'b0 == m_axi_in_r_RVALID)))) begin
        ...
        i_cast1_reg_112[6 : 0] <= i_cast1_fu_90_p1[6 : 0];
    end
end
...
assign c5_b_i13_cast1_fu_79_p1 = c5_b_i13;

assign exitcond_fu_94_p2 = ((i_reg_68 == 7'd120) ? 1'b1 : 1'b0);

assign i_13_fu_100_p2 = (i_reg_68 + 7'd1);

assign i_cast1_fu_90_p1 = i_reg_68;

assign m_axi_in_r_ARADDR = c5_b_i13_cast1_fu_79_p1;
...
assign m_axi_in_r_ARLEN = 32'd120;
...
always @ (posedge ap_clk) begin
    i_cast1_reg_112[31:7] <= 25'b0000000000000000000000000;
end
