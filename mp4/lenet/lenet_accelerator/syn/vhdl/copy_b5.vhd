...
architecture behav of copy_b5 is 
    ...
    signal i_13_fu_100_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal i_13_reg_120 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal c5_b_i13_cast1_fu_79_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state8) and not(((ap_const_lv1_0 = exitcond_fu_94_p2) and (ap_const_logic_0 = m_axi_in_r_RVALID))))) then
                i_13_reg_120 <= i_13_fu_100_p2;
                    i_cast1_reg_112(6 downto 0) <= i_cast1_fu_90_p1(6 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    i_cast1_reg_112(31 downto 7) <= "0000000000000000000000000";
    ...
    c5_b_i13_cast1_fu_79_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(c5_b_i13),32));
    exitcond_fu_94_p2 <= "1" when (i_reg_68 = ap_const_lv7_78) else "0";
    i_13_fu_100_p2 <= std_logic_vector(unsigned(i_reg_68) + unsigned(ap_const_lv7_1));
    ...
    m_axi_in_r_ARADDR <= c5_b_i13_cast1_fu_79_p1;
    ...
    out_r_address0 <= i_cast1_reg_112(7 - 1 downto 0);
