...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename fc6_o \
    op interface \
    ports { fc6_o_address0 { O 4 vector } fc6_o_ce0 { O 1 bit } fc6_o_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'fc6_o'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_fc6_o_o15 \
    op interface \
    ports { fc6_o_o15 { I 30 vector } } \
} "
}
