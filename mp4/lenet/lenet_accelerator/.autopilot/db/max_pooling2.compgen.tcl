...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename c1_o_2 \
    op interface \
    ports { c1_o_2_address0 { O 13 vector } c1_o_2_ce0 { O 1 bit } c1_o_2_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'c1_o_2'"
}
}
