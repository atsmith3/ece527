...
#ifndef __convolution3_fcmprcU__HH__
#define __convolution3_fcmprcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolution3_fcmprcU) {
    ...
    SC_CTOR(convolution3_fcmprcU):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
