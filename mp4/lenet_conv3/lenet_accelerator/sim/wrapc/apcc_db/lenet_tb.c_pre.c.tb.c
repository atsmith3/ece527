...
signed int convolution3(float (*)[14][14], float (*)[6][5][5], float *, float (*)[10][10]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%158 = call i32 @convolution3([14 x [14 x float]]* %%154, [6 x [5 x [5 x float]]]* %%155, float* %%78, [10 x [10 x float]]* %%157) nounwind, !dbg !13 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_822_count);
  convolution3(llvm_cbe_tmp__211, llvm_cbe_tmp__212, (float *)llvm_cbe_tmp__135, llvm_cbe_tmp__214);
if (AESL_DEBUG_TRACE) {
