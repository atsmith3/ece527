...
; <label>:4                                       ; preds = %3
  ...
  %rend28 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i32 0, i32 0), i32 %rbegin3) nounwind, !dbg !88 ; [#uses=0 type=i32] [debug line = 27:3]
...
; <label>:5                                       ; preds = %3
  %rend26 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str8, i32 0, i32 0), i32 %rbegin1) nounwind, !dbg !91 ; [#uses=0 type=i32] [debug line = 28:2]
...
; <label>:10                                      ; preds = %7
  %rend30 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str10, i32 0, i32 0), i32 %rbegin2) nounwind, !dbg !112 ; [#uses=0 type=i32] [debug line = 38:2]
...
.preheader12:                                     ; preds = %21, %.preheader12.preheader
  ...
  br i1 %exitcond2, label %22, label %.preheader.preheader, !dbg !122 ; [debug line = 61:9]

.preheader.preheader:                             ; preds = %.preheader12
  br label %.preheader, !dbg !150                 ; [debug line = 62:7]

.preheader:                                       ; preds = %20, %.preheader.preheader
  %j.3 = phi i32 [ %j.7, %20 ], [ 0, %.preheader.preheader ] ; [#uses=4 type=i32]
  %exitcond1 = icmp eq i32 %j.3, 28, !dbg !150    ; [#uses=1 type=i1] [debug line = 62:7]
  br i1 %exitcond1, label %21, label %17, !dbg !150 ; [debug line = 62:7]

; <label>:17                                      ; preds = %.preheader
  %rbegin5 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str13, i32 0, i32 0)) nounwind, !dbg !153 ; [#uses=1 type=i32] [debug line = 62:28]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !155 ; [debug line = 63:1]
  br label %18, !dbg !156                         ; [debug line = 64:6]

; <label>:18                                      ; preds = %19, %17
  %k.1 = phi i32 [ 0, %17 ], [ %k.3, %19 ]        ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %k.1, 28, !dbg !156     ; [#uses=1 type=i1] [debug line = 64:6]
  br i1 %exitcond, label %20, label %19, !dbg !156 ; [debug line = 64:6]

; <label>:19                                      ; preds = %18
  %rbegin6 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str14, i32 0, i32 0)) nounwind, !dbg !158 ; [#uses=1 type=i32] [debug line = 64:27]
  ...
  %rend24 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str14, i32 0, i32 0), i32 %rbegin6) nounwind, !dbg !162 ; [#uses=0 type=i32] [debug line = 67:4]
  %k.3 = add nsw i32 %k.1, 1, !dbg !163           ; [#uses=1 type=i32] [debug line = 64:21]
  call void @llvm.dbg.value(metadata !{i32 %k.3}, i64 0, metadata !110), !dbg !163 ; [debug line = 64:21] [debug variable = k]
  br label %18, !dbg !163                         ; [debug line = 64:21]

; <label>:20                                      ; preds = %18
  %rend22 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str13, i32 0, i32 0), i32 %rbegin5) nounwind, !dbg !164 ; [#uses=0 type=i32] [debug line = 68:3]
  %j.7 = add nsw i32 %j.3, 1, !dbg !165           ; [#uses=1 type=i32] [debug line = 62:22]
  call void @llvm.dbg.value(metadata !{i32 %j.7}, i64 0, metadata !90), !dbg !165 ; [debug line = 62:22] [debug variable = j]
  br label %.preheader, !dbg !165                 ; [debug line = 62:22]
...
!150 = metadata !{i32 62, i32 7, metadata !151, null}
!151 = metadata !{i32 786443, metadata !152, i32 62, i32 3, metadata !6, i32 25} ; [ DW_TAG_lexical_block ]
!152 = metadata !{i32 786443, metadata !123, i32 61, i32 28, metadata !6, i32 24} ; [ DW_TAG_lexical_block ]
!153 = metadata !{i32 62, i32 28, metadata !154, null}
!154 = metadata !{i32 786443, metadata !151, i32 62, i32 27, metadata !6, i32 26} ; [ DW_TAG_lexical_block ]
!155 = metadata !{i32 63, i32 1, metadata !154, null}
!156 = metadata !{i32 64, i32 6, metadata !157, null}
!157 = metadata !{i32 786443, metadata !154, i32 64, i32 2, metadata !6, i32 27} ; [ DW_TAG_lexical_block ]
!158 = metadata !{i32 64, i32 27, metadata !159, null}
!159 = metadata !{i32 786443, metadata !157, i32 64, i32 26, metadata !6, i32 28} ; [ DW_TAG_lexical_block ]
...
!163 = metadata !{i32 64, i32 21, metadata !157, null}
!164 = metadata !{i32 68, i32 3, metadata !154, null}
!165 = metadata !{i32 62, i32 22, metadata !151, null}
