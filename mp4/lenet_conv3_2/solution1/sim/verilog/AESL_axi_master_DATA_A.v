...
//------------------------Parameter----------------------
`define TV_IN_DATA_A "../tv/cdatafile/c.convolution3.autotvin_DATA_A.dat"
`define TV_OUT_DATA_A "../tv/rtldatafile/rtl.convolution3.autotvout_DATA_A.dat"
...
parameter DATA_A_mem_depth = 32'd 1176;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > DATA_A_mem_depth) begin
                $display ("C:/Users/anges/Documents/UIUC/ECE_527/ece527/mp4/lenet_conv3_2/solution1/sim/verilog/AESL_axi_master_DATA_A.v: Write request address %d exceed AXI master DATA_A array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, DATA_A_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > DATA_A_mem_depth) begin
                $display ("C:/Users/anges/Documents/UIUC/ECE_527/ece527/mp4/lenet_conv3_2/solution1/sim/verilog/AESL_axi_master_DATA_A.v: Read request address %d exceed AXI master DATA_A array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, DATA_A_mem_depth); 
                $finish;
            end
