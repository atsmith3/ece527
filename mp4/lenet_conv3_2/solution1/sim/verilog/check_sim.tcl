...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.convolution3.autotvin_DATA_A.dat"
         "c.convolution3.autotvin_DATA_B.dat"
         "c.convolution3.autotvin_DATA_C.dat"
         "c.convolution3.autotvin_input_r.dat"
         "c.convolution3.autotvin_weights.dat"
         "c.convolution3.autotvin_bias.dat"
         "c.convolution3.autotvin_output_r.dat"
         "c.convolution3.autotvout_DATA_D.dat"
         "c.convolution3.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.convolution3.autotvout_DATA_D.dat"
         "rtl.convolution3.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
