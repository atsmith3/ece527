...
if {[file isfile convolution3.autotvin.dat]} {
	file delete -force convolution3.autotvin.dat
}

if {[file isfile convolution3.autotvout.dat]} {
	file delete -force convolution3.autotvout.dat
}
