...
//------------------------Parameter----------------------
`define TV_IN_DATA_B "../tv/cdatafile/c.convolution3.autotvin_DATA_B.dat"
`define TV_OUT_DATA_B "../tv/rtldatafile/rtl.convolution3.autotvout_DATA_B.dat"
 parameter DATA_B_ADDR_BITWIDTH = 32'd 32;
 parameter DATA_B_AWUSER_BITWIDTH = 32'd 1;
 parameter DATA_B_DATA_BITWIDTH = 32'd 32;
 parameter DATA_B_WUSER_BITWIDTH = 32'd 1;
 parameter DATA_B_ID_BITWIDTH = 32'd 1;
...
parameter DATA_B_mem_depth = 32'd 2400;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_DATA_B_AWVALID;
output  TRAN_DATA_B_AWREADY;
input [DATA_B_ADDR_BITWIDTH - 1 : 0] TRAN_DATA_B_AWADDR;
input [DATA_B_ID_BITWIDTH - 1 : 0] TRAN_DATA_B_AWID;
input [8 - 1 : 0] TRAN_DATA_B_AWLEN;
input [3 - 1 : 0] TRAN_DATA_B_AWSIZE;
input [2 - 1 : 0] TRAN_DATA_B_AWBURST;
input [2 - 1 : 0] TRAN_DATA_B_AWLOCK;
input [4 - 1 : 0] TRAN_DATA_B_AWCACHE;
input [3 - 1 : 0] TRAN_DATA_B_AWPROT;
input [4 - 1 : 0] TRAN_DATA_B_AWQOS;
input [4 - 1 : 0] TRAN_DATA_B_AWREGION;
input [DATA_B_AWUSER_BITWIDTH - 1 : 0] TRAN_DATA_B_AWUSER;
input  TRAN_DATA_B_WVALID;
output  TRAN_DATA_B_WREADY;
input [DATA_B_DATA_BITWIDTH - 1 : 0] TRAN_DATA_B_WDATA;
input [DATA_B_DATA_BITWIDTH/8 - 1 : 0] TRAN_DATA_B_WSTRB;
input  TRAN_DATA_B_WLAST;
input  TRAN_DATA_B_WID;
input [DATA_B_WUSER_BITWIDTH - 1 : 0] TRAN_DATA_B_WUSER;
input  TRAN_DATA_B_ARVALID;
output  TRAN_DATA_B_ARREADY;
input [DATA_B_ADDR_BITWIDTH - 1 : 0] TRAN_DATA_B_ARADDR;
input [DATA_B_ID_BITWIDTH - 1 : 0] TRAN_DATA_B_ARID;
input [8 - 1 : 0] TRAN_DATA_B_ARLEN;
input [3 - 1 : 0] TRAN_DATA_B_ARSIZE;
input [2 - 1 : 0] TRAN_DATA_B_ARBURST;
input [2 - 1 : 0] TRAN_DATA_B_ARLOCK;
input [4 - 1 : 0] TRAN_DATA_B_ARCACHE;
input [3 - 1 : 0] TRAN_DATA_B_ARPROT;
input [4 - 1 : 0] TRAN_DATA_B_ARQOS;
input [4 - 1 : 0] TRAN_DATA_B_ARREGION;
input  TRAN_DATA_B_ARUSER;
output  TRAN_DATA_B_RVALID;
input  TRAN_DATA_B_RREADY;
output [DATA_B_DATA_BITWIDTH - 1 : 0] TRAN_DATA_B_RDATA;
output  TRAN_DATA_B_RLAST;
output [DATA_B_ID_BITWIDTH - 1 : 0] TRAN_DATA_B_RID;
output [DATA_B_RUSER_BITWIDTH - 1 : 0] TRAN_DATA_B_RUSER;
output [2 - 1 : 0] TRAN_DATA_B_RRESP;
output  TRAN_DATA_B_BVALID;
input  TRAN_DATA_B_BREADY;
output [2 - 1 : 0] TRAN_DATA_B_BRESP;
output [DATA_B_ID_BITWIDTH - 1 : 0] TRAN_DATA_B_BID;
output [DATA_B_BUSER_BITWIDTH - 1 : 0] TRAN_DATA_B_BUSER;
output [32 - 1 : 0] TRAN_DATA_B_weights;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [DATA_B_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [DATA_B_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [DATA_B_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [DATA_B_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [DATA_B_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [DATA_B_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [DATA_B_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
...
reg [DATA_B_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [DATA_B_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [DATA_B_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_DATA_B_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_DATA_B_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_DATA_B_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_DATA_B_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_DATA_B_BRESP = BRESP_tmp;
assign TRAN_DATA_B_RDATA = RDATA_tmp;
assign TRAN_DATA_B_RRESP = RRESP_tmp;
assign TRAN_DATA_B_RLAST = RLAST_tmp;
assign TRAN_DATA_B_RVALID = RVALID_tmp;
assign    TRAN_DATA_B_weights = weights;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = DATA_B_C_DATA_BITWIDTH;
  count_c_data_byte_num_by_bitwidth (c_bitwidth , DATA_byte_num);
  weights <= 0 * DATA_byte_num;
end

initial begin : initialize_DATA_B_mem
  integer i;
  for (i = 0; i < DATA_B_mem_depth; i = i + 1) begin
      DATA_B_mem_0[i] = 0;
      DATA_B_mem_1[i] = 0;
      DATA_B_mem_2[i] = 0;
      DATA_B_mem_3[i] = 0;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_DATA_B_AWREADY & TRAN_DATA_B_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_DATA_B_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_DATA_B_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_DATA_B_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_DATA_B_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_DATA_B_ARREADY & TRAN_DATA_B_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_DATA_B_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_DATA_B_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_DATA_B_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_DATA_B_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_DATA_B_WREADY & TRAN_DATA_B_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_DATA_B_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_DATA_B_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_DATA_B_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_DATA_B_AWVALID && TRAN_DATA_B_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_DATA_B_ARVALID && TRAN_DATA_B_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_DATA_B_WVALID && TRAN_DATA_B_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_DATA_B_WVALID && TRAN_DATA_B_WREADY && TRAN_DATA_B_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_DATA_B_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_DATA_B_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [DATA_B_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [DATA_B_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [DATA_B_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > DATA_B_mem_depth) begin
                $display ("C:/Users/anges/Documents/UIUC/ECE_527/ece527/mp4/lenet_conv3_2/solution1/sim/verilog/AESL_axi_master_DATA_B.v: Write request address %d exceed AXI master DATA_B array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, DATA_B_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > DATA_B_mem_depth) begin
                $display ("C:/Users/anges/Documents/UIUC/ECE_527/ece527/mp4/lenet_conv3_2/solution1/sim/verilog/AESL_axi_master_DATA_B.v: Read request address %d exceed AXI master DATA_B array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, DATA_B_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_DATA_B_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer DATA_B_bitwidth; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [DATA_B_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [DATA_B_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  DATA_B_bitwidth = DATA_B_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (DATA_B_bitwidth , factor);
  fp = $fopen(`TV_IN_DATA_B,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_DATA_B); 
      $finish; 
  end 
  token = read_token(fp); 
