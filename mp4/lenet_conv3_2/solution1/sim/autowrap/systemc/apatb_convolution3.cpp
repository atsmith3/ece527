...
#define AUTOTB_TVIN_DATA_D  "../tv/cdatafile/c.convolution3.autotvin_DATA_D.dat"
...
#define AUTOTB_TVOUT_PC_DATA_D  "../tv/rtldatafile/rtl.convolution3.autotvout_DATA_D.dat"
// tvout file define: "ap_return"
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.convolution3.autotvout_ap_return.dat"
...
extern "C" int convolution3 (
float input[6][14][14],
float weights[16][6][5][5],
float bias[16],
float output[16][10][10]);

extern "C" int AESL_WRAP_convolution3 (
float input[6][14][14],
float weights[16][6][5][5],
float bias[16],
float output[16][10][10])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *DATA_D_pc_buffer = new sc_bv<32>[1600];
			int i = 0;
							...
							for (int i_0 = 0; i_0 <= 15; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 9; i_1 += 1)
								{
									...
									for (int i_2 = 0; i_2 <= 9; i_2 += 1)
									{
										...
										{
											output_lv0_0_15_1_lv1_0_9_1_lv2_0_9_1[hls_map_index].range(31, 0) = sc_bv<32>(DATA_D_pc_buffer[hls_map_index].range(31, 0));
											hls_map_index++;
										}
									}
								}
	...
	else
	{
		...
		sc_bv<32>* DATA_A_tvin_wrapc_buffer = new sc_bv<32>[1176];
		...
		tcl_file.set_num(1176, &tcl_file.DATA_A_depth);
		...
		sc_bv<32>* DATA_B_tvin_wrapc_buffer = new sc_bv<32>[2400];
		...
		tcl_file.set_num(2400, &tcl_file.DATA_B_depth);
		...
		sc_bv<32>* DATA_C_tvin_wrapc_buffer = new sc_bv<32>[16];
		...
		tcl_file.set_num(16, &tcl_file.DATA_C_depth);
		...
		sc_bv<32>* DATA_D_tvin_wrapc_buffer = new sc_bv<32>[1600];
		...
		tcl_file.set_num(1600, &tcl_file.DATA_D_depth);
...
// [call_c_dut] ---------->
		...
		int AESL_return = convolution3(input, weights, bias, output);
		...
		sc_bv<32>* DATA_D_tvout_wrapc_buffer = new sc_bv<32>[1600];
