...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "convolution3.autotvin.dat"
	set constFileTvOut       "convolution3.autotvout.dat"
	set constFileHdlTvIn     "convolution3.autohdltvin.dat"
	set constFileHdlTvOut    "convolution3.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
