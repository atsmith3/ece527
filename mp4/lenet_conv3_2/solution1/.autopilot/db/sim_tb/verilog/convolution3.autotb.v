...
`define AUTOTB_DUT      convolution3
`define AUTOTB_DUT_INST AESL_inst_convolution3
`define AUTOTB_TOP      apatb_convolution3_top
`define AUTOTB_LAT_RESULT_FILE "convolution3.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "convolution3.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_convolution3_top
...
`define AESL_DEPTH_DATA_D 1
`define AESL_DEPTH_input_r 1
`define AESL_DEPTH_weights 1
`define AESL_DEPTH_bias 1
`define AESL_DEPTH_output_r 1
`define AUTOTB_TVIN_DATA_A  "./c.convolution3.autotvin_DATA_A.dat"
`define AUTOTB_TVIN_DATA_B  "./c.convolution3.autotvin_DATA_B.dat"
`define AUTOTB_TVIN_DATA_C  "./c.convolution3.autotvin_DATA_C.dat"
`define AUTOTB_TVIN_input_r  "./c.convolution3.autotvin_input_r.dat"
`define AUTOTB_TVIN_weights  "./c.convolution3.autotvin_weights.dat"
`define AUTOTB_TVIN_bias  "./c.convolution3.autotvin_bias.dat"
`define AUTOTB_TVIN_output_r  "./c.convolution3.autotvin_output_r.dat"
`define AUTOTB_TVIN_DATA_A_out_wrapc  "./rtl.convolution3.autotvin_DATA_A.dat"
`define AUTOTB_TVIN_DATA_B_out_wrapc  "./rtl.convolution3.autotvin_DATA_B.dat"
`define AUTOTB_TVIN_DATA_C_out_wrapc  "./rtl.convolution3.autotvin_DATA_C.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "./rtl.convolution3.autotvin_input_r.dat"
`define AUTOTB_TVIN_weights_out_wrapc  "./rtl.convolution3.autotvin_weights.dat"
`define AUTOTB_TVIN_bias_out_wrapc  "./rtl.convolution3.autotvin_bias.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "./rtl.convolution3.autotvin_output_r.dat"
`define AUTOTB_TVOUT_DATA_D  "./c.convolution3.autotvout_DATA_D.dat"
`define AUTOTB_TVOUT_ap_return  "./c.convolution3.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_DATA_D_out_wrapc  "./impl_rtl.convolution3.autotvout_DATA_D.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.convolution3.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_DATA_A = 1176;
parameter LENGTH_DATA_B = 2400;
parameter LENGTH_DATA_C = 16;
parameter LENGTH_DATA_D = 1600;
...
wire  DATA_D_AWVALID;
wire  DATA_D_AWREADY;
wire [31 : 0] DATA_D_AWADDR;
wire [0 : 0] DATA_D_AWID;
wire [7 : 0] DATA_D_AWLEN;
wire [2 : 0] DATA_D_AWSIZE;
wire [1 : 0] DATA_D_AWBURST;
wire [1 : 0] DATA_D_AWLOCK;
wire [3 : 0] DATA_D_AWCACHE;
wire [2 : 0] DATA_D_AWPROT;
wire [3 : 0] DATA_D_AWQOS;
wire [3 : 0] DATA_D_AWREGION;
wire [0 : 0] DATA_D_AWUSER;
wire  DATA_D_WVALID;
wire  DATA_D_WREADY;
wire [31 : 0] DATA_D_WDATA;
wire [3 : 0] DATA_D_WSTRB;
wire  DATA_D_WLAST;
wire [0 : 0] DATA_D_WID;
wire [0 : 0] DATA_D_WUSER;
wire  DATA_D_ARVALID;
wire  DATA_D_ARREADY;
wire [31 : 0] DATA_D_ARADDR;
wire [0 : 0] DATA_D_ARID;
wire [7 : 0] DATA_D_ARLEN;
wire [2 : 0] DATA_D_ARSIZE;
wire [1 : 0] DATA_D_ARBURST;
wire [1 : 0] DATA_D_ARLOCK;
wire [3 : 0] DATA_D_ARCACHE;
wire [2 : 0] DATA_D_ARPROT;
wire [3 : 0] DATA_D_ARQOS;
wire [3 : 0] DATA_D_ARREGION;
wire [0 : 0] DATA_D_ARUSER;
wire  DATA_D_RVALID;
wire  DATA_D_RREADY;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .m_axi_DATA_D_AWVALID(DATA_D_AWVALID),
    .m_axi_DATA_D_AWREADY(DATA_D_AWREADY),
    .m_axi_DATA_D_AWADDR(DATA_D_AWADDR),
    .m_axi_DATA_D_AWID(DATA_D_AWID),
    .m_axi_DATA_D_AWLEN(DATA_D_AWLEN),
    .m_axi_DATA_D_AWSIZE(DATA_D_AWSIZE),
    .m_axi_DATA_D_AWBURST(DATA_D_AWBURST),
    .m_axi_DATA_D_AWLOCK(DATA_D_AWLOCK),
    .m_axi_DATA_D_AWCACHE(DATA_D_AWCACHE),
    .m_axi_DATA_D_AWPROT(DATA_D_AWPROT),
    .m_axi_DATA_D_AWQOS(DATA_D_AWQOS),
    .m_axi_DATA_D_AWREGION(DATA_D_AWREGION),
    .m_axi_DATA_D_AWUSER(DATA_D_AWUSER),
    .m_axi_DATA_D_WVALID(DATA_D_WVALID),
    .m_axi_DATA_D_WREADY(DATA_D_WREADY),
    .m_axi_DATA_D_WDATA(DATA_D_WDATA),
    .m_axi_DATA_D_WSTRB(DATA_D_WSTRB),
    .m_axi_DATA_D_WLAST(DATA_D_WLAST),
    .m_axi_DATA_D_WID(DATA_D_WID),
    .m_axi_DATA_D_WUSER(DATA_D_WUSER),
    .m_axi_DATA_D_ARVALID(DATA_D_ARVALID),
    .m_axi_DATA_D_ARREADY(DATA_D_ARREADY),
    .m_axi_DATA_D_ARADDR(DATA_D_ARADDR),
    .m_axi_DATA_D_ARID(DATA_D_ARID),
    .m_axi_DATA_D_ARLEN(DATA_D_ARLEN),
    .m_axi_DATA_D_ARSIZE(DATA_D_ARSIZE),
    .m_axi_DATA_D_ARBURST(DATA_D_ARBURST),
    .m_axi_DATA_D_ARLOCK(DATA_D_ARLOCK),
    .m_axi_DATA_D_ARCACHE(DATA_D_ARCACHE),
    .m_axi_DATA_D_ARPROT(DATA_D_ARPROT),
    .m_axi_DATA_D_ARQOS(DATA_D_ARQOS),
    .m_axi_DATA_D_ARREGION(DATA_D_ARREGION),
    .m_axi_DATA_D_ARUSER(DATA_D_ARUSER),
    .m_axi_DATA_D_RVALID(DATA_D_RVALID),
    .m_axi_DATA_D_RREADY(DATA_D_RREADY),
    .m_axi_DATA_D_RDATA(DATA_D_RDATA),
    .m_axi_DATA_D_RLAST(DATA_D_RLAST),
    .m_axi_DATA_D_RID(DATA_D_RID),
    .m_axi_DATA_D_RUSER(DATA_D_RUSER),
    .m_axi_DATA_D_RRESP(DATA_D_RRESP),
    .m_axi_DATA_D_BVALID(DATA_D_BVALID),
    .m_axi_DATA_D_BREADY(DATA_D_BREADY),
    .m_axi_DATA_D_BRESP(DATA_D_BRESP),
    .m_axi_DATA_D_BID(DATA_D_BID),
    .m_axi_DATA_D_BUSER(DATA_D_BUSER));
...
wire    AESL_axi_master_DATA_D_ready;
wire    AESL_axi_master_DATA_D_done;
wire [32 - 1:0] output_r;
AESL_axi_master_DATA_D AESL_AXI_MASTER_DATA_D(
    .clk   (AESL_clock),
    .reset (AESL_reset),
    .TRAN_DATA_D_AWVALID (DATA_D_AWVALID),
    .TRAN_DATA_D_AWREADY (DATA_D_AWREADY),
    .TRAN_DATA_D_AWADDR (DATA_D_AWADDR),
    .TRAN_DATA_D_AWID (DATA_D_AWID),
    .TRAN_DATA_D_AWLEN (DATA_D_AWLEN),
    .TRAN_DATA_D_AWSIZE (DATA_D_AWSIZE),
    .TRAN_DATA_D_AWBURST (DATA_D_AWBURST),
    .TRAN_DATA_D_AWLOCK (DATA_D_AWLOCK),
    .TRAN_DATA_D_AWCACHE (DATA_D_AWCACHE),
    .TRAN_DATA_D_AWPROT (DATA_D_AWPROT),
    .TRAN_DATA_D_AWQOS (DATA_D_AWQOS),
    .TRAN_DATA_D_AWREGION (DATA_D_AWREGION),
    .TRAN_DATA_D_AWUSER (DATA_D_AWUSER),
    .TRAN_DATA_D_WVALID (DATA_D_WVALID),
    .TRAN_DATA_D_WREADY (DATA_D_WREADY),
    .TRAN_DATA_D_WDATA (DATA_D_WDATA),
    .TRAN_DATA_D_WSTRB (DATA_D_WSTRB),
    .TRAN_DATA_D_WLAST (DATA_D_WLAST),
    .TRAN_DATA_D_WID (DATA_D_WID),
    .TRAN_DATA_D_WUSER (DATA_D_WUSER),
    .TRAN_DATA_D_ARVALID (DATA_D_ARVALID),
    .TRAN_DATA_D_ARREADY (DATA_D_ARREADY),
    .TRAN_DATA_D_ARADDR (DATA_D_ARADDR),
    .TRAN_DATA_D_ARID (DATA_D_ARID),
    .TRAN_DATA_D_ARLEN (DATA_D_ARLEN),
    .TRAN_DATA_D_ARSIZE (DATA_D_ARSIZE),
    .TRAN_DATA_D_ARBURST (DATA_D_ARBURST),
    .TRAN_DATA_D_ARLOCK (DATA_D_ARLOCK),
    .TRAN_DATA_D_ARCACHE (DATA_D_ARCACHE),
    .TRAN_DATA_D_ARPROT (DATA_D_ARPROT),
    .TRAN_DATA_D_ARQOS (DATA_D_ARQOS),
    .TRAN_DATA_D_ARREGION (DATA_D_ARREGION),
    .TRAN_DATA_D_ARUSER (DATA_D_ARUSER),
    .TRAN_DATA_D_RVALID (DATA_D_RVALID),
    .TRAN_DATA_D_RREADY (DATA_D_RREADY),
    .TRAN_DATA_D_RDATA (DATA_D_RDATA),
    .TRAN_DATA_D_RLAST (DATA_D_RLAST),
    .TRAN_DATA_D_RID (DATA_D_RID),
    .TRAN_DATA_D_RUSER (DATA_D_RUSER),
    .TRAN_DATA_D_RRESP (DATA_D_RRESP),
    .TRAN_DATA_D_BVALID (DATA_D_BVALID),
    .TRAN_DATA_D_BREADY (DATA_D_BREADY),
    .TRAN_DATA_D_BRESP (DATA_D_BRESP),
    .TRAN_DATA_D_BID (DATA_D_BID),
    .TRAN_DATA_D_BUSER (DATA_D_BUSER),
    .TRAN_DATA_D_output_r (output_r),
    .ready (AESL_axi_master_DATA_D_ready),
    .done  (AESL_axi_master_DATA_D_done)
);
assign    AESL_axi_master_DATA_D_ready    =   ready;
assign    AESL_axi_master_DATA_D_done    =   AESL_done_delay;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.convolution3.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.convolution3.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.convolution3.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.convolution3.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.convolution3.autotvout_ap_return.dat with impl_rtl.convolution3.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
reg end_DATA_D;
reg [31:0] size_DATA_D;
reg [31:0] size_DATA_D_backup;
reg end_ap_return;
...
reg dump_tvout_finish_DATA_D;

initial begin : dump_tvout_runtime_sign_DATA_D
    integer fp;
    dump_tvout_finish_DATA_D = 0;
    fp = $fopen(`AUTOTB_TVOUT_DATA_D_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_DATA_D_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_DATA_D_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_DATA_D_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
