...
`define AUTOTB_TVIN_DATA_A_out_wrapc  "../tv/rtldatafile/rtl.convolution1.autotvin_DATA_A.dat"
`define AUTOTB_TVIN_DATA_B_out_wrapc  "../tv/rtldatafile/rtl.convolution1.autotvin_DATA_B.dat"
`define AUTOTB_TVIN_DATA_C_out_wrapc  "../tv/rtldatafile/rtl.convolution1.autotvin_DATA_C.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.convolution1.autotvin_input_r.dat"
`define AUTOTB_TVIN_weights_out_wrapc  "../tv/rtldatafile/rtl.convolution1.autotvin_weights.dat"
`define AUTOTB_TVIN_bias_out_wrapc  "../tv/rtldatafile/rtl.convolution1.autotvin_bias.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "../tv/rtldatafile/rtl.convolution1.autotvin_output_r.dat"
...
`define AUTOTB_TVOUT_DATA_D_out_wrapc  "../tv/rtldatafile/rtl.convolution1.autotvout_DATA_D.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.convolution1.autotvout_ap_return.dat"
module `AUTOTB_TOP;
