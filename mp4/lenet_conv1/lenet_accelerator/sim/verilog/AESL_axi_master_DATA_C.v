...
//------------------------Parameter----------------------
`define TV_IN_DATA_C "../tv/cdatafile/c.fc6.autotvin_DATA_C.dat"
`define TV_OUT_DATA_C "../tv/rtldatafile/rtl.fc6.autotvout_DATA_C.dat"
...
parameter DATA_C_mem_depth = 32'd 10;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > DATA_C_mem_depth) begin
                $display ("C:/Users/anges/Documents/UIUC/ECE_527/ece527/mp4/lenet_fcl/lenet_accelerator/sim/verilog/AESL_axi_master_DATA_C.v: Write request address %d exceed AXI master DATA_C array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, DATA_C_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > DATA_C_mem_depth) begin
                $display ("C:/Users/anges/Documents/UIUC/ECE_527/ece527/mp4/lenet_fcl/lenet_accelerator/sim/verilog/AESL_axi_master_DATA_C.v: Read request address %d exceed AXI master DATA_C array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, DATA_C_mem_depth); 
                $finish;
            end
