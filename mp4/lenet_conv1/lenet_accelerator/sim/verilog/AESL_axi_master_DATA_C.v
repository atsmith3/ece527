...
//------------------------Parameter----------------------
`define TV_IN_DATA_C "../tv/cdatafile/c.convolution1.autotvin_DATA_C.dat"
`define TV_OUT_DATA_C "../tv/rtldatafile/rtl.convolution1.autotvout_DATA_C.dat"
 parameter DATA_C_ADDR_BITWIDTH = 32'd 32;
 parameter DATA_C_AWUSER_BITWIDTH = 32'd 1;
 parameter DATA_C_DATA_BITWIDTH = 32'd 32;
 parameter DATA_C_WUSER_BITWIDTH = 32'd 1;
 parameter DATA_C_ID_BITWIDTH = 32'd 1;
 parameter DATA_C_RUSER_BITWIDTH = 32'd 1;
 parameter DATA_C_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter DATA_C_C_DATA_BITWIDTH = 32'd 32;
parameter DATA_C_mem_depth = 32'd 6;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_DATA_C_AWVALID;
output  TRAN_DATA_C_AWREADY;
input [DATA_C_ADDR_BITWIDTH - 1 : 0] TRAN_DATA_C_AWADDR;
input [DATA_C_ID_BITWIDTH - 1 : 0] TRAN_DATA_C_AWID;
input [8 - 1 : 0] TRAN_DATA_C_AWLEN;
input [3 - 1 : 0] TRAN_DATA_C_AWSIZE;
input [2 - 1 : 0] TRAN_DATA_C_AWBURST;
input [2 - 1 : 0] TRAN_DATA_C_AWLOCK;
input [4 - 1 : 0] TRAN_DATA_C_AWCACHE;
input [3 - 1 : 0] TRAN_DATA_C_AWPROT;
input [4 - 1 : 0] TRAN_DATA_C_AWQOS;
input [4 - 1 : 0] TRAN_DATA_C_AWREGION;
input [DATA_C_AWUSER_BITWIDTH - 1 : 0] TRAN_DATA_C_AWUSER;
input  TRAN_DATA_C_WVALID;
output  TRAN_DATA_C_WREADY;
input [DATA_C_DATA_BITWIDTH - 1 : 0] TRAN_DATA_C_WDATA;
input [DATA_C_DATA_BITWIDTH/8 - 1 : 0] TRAN_DATA_C_WSTRB;
input  TRAN_DATA_C_WLAST;
input  TRAN_DATA_C_WID;
input [DATA_C_WUSER_BITWIDTH - 1 : 0] TRAN_DATA_C_WUSER;
input  TRAN_DATA_C_ARVALID;
output  TRAN_DATA_C_ARREADY;
input [DATA_C_ADDR_BITWIDTH - 1 : 0] TRAN_DATA_C_ARADDR;
input [DATA_C_ID_BITWIDTH - 1 : 0] TRAN_DATA_C_ARID;
input [8 - 1 : 0] TRAN_DATA_C_ARLEN;
input [3 - 1 : 0] TRAN_DATA_C_ARSIZE;
input [2 - 1 : 0] TRAN_DATA_C_ARBURST;
input [2 - 1 : 0] TRAN_DATA_C_ARLOCK;
input [4 - 1 : 0] TRAN_DATA_C_ARCACHE;
input [3 - 1 : 0] TRAN_DATA_C_ARPROT;
input [4 - 1 : 0] TRAN_DATA_C_ARQOS;
input [4 - 1 : 0] TRAN_DATA_C_ARREGION;
input  TRAN_DATA_C_ARUSER;
output  TRAN_DATA_C_RVALID;
input  TRAN_DATA_C_RREADY;
output [DATA_C_DATA_BITWIDTH - 1 : 0] TRAN_DATA_C_RDATA;
output  TRAN_DATA_C_RLAST;
output [DATA_C_ID_BITWIDTH - 1 : 0] TRAN_DATA_C_RID;
output [DATA_C_RUSER_BITWIDTH - 1 : 0] TRAN_DATA_C_RUSER;
output [2 - 1 : 0] TRAN_DATA_C_RRESP;
output  TRAN_DATA_C_BVALID;
input  TRAN_DATA_C_BREADY;
output [2 - 1 : 0] TRAN_DATA_C_BRESP;
output [DATA_C_ID_BITWIDTH - 1 : 0] TRAN_DATA_C_BID;
output [DATA_C_BUSER_BITWIDTH - 1 : 0] TRAN_DATA_C_BUSER;
output [32 - 1 : 0] TRAN_DATA_C_bias;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [DATA_C_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [DATA_C_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [DATA_C_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [DATA_C_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [DATA_C_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [DATA_C_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [DATA_C_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [32 - 1 : 0] bias = 0;
reg [DATA_C_DATA_BITWIDTH - 1 : 0] DATA_C_mem_0 [0: DATA_C_mem_depth - 1]; 
reg [DATA_C_DATA_BITWIDTH - 1 : 0] DATA_C_mem_1 [0: DATA_C_mem_depth - 1]; 
reg [DATA_C_DATA_BITWIDTH - 1 : 0] DATA_C_mem_2 [0: DATA_C_mem_depth - 1]; 
reg [DATA_C_DATA_BITWIDTH - 1 : 0] DATA_C_mem_3 [0: DATA_C_mem_depth - 1]; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [DATA_C_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [DATA_C_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [DATA_C_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_DATA_C_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_DATA_C_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_DATA_C_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_DATA_C_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_DATA_C_BRESP = BRESP_tmp;
assign TRAN_DATA_C_RDATA = RDATA_tmp;
assign TRAN_DATA_C_RRESP = RRESP_tmp;
assign TRAN_DATA_C_RLAST = RLAST_tmp;
assign TRAN_DATA_C_RVALID = RVALID_tmp;
assign    TRAN_DATA_C_bias = bias;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = DATA_C_C_DATA_BITWIDTH;
  count_c_data_byte_num_by_bitwidth (c_bitwidth , DATA_byte_num);
  bias <= 0 * DATA_byte_num;
end

initial begin : initialize_DATA_C_mem
  integer i;
  for (i = 0; i < DATA_C_mem_depth; i = i + 1) begin
      DATA_C_mem_0[i] = 0;
      DATA_C_mem_1[i] = 0;
      DATA_C_mem_2[i] = 0;
      DATA_C_mem_3[i] = 0;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_DATA_C_AWREADY & TRAN_DATA_C_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_DATA_C_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_DATA_C_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_DATA_C_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_DATA_C_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_DATA_C_ARREADY & TRAN_DATA_C_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_DATA_C_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_DATA_C_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_DATA_C_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_DATA_C_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_DATA_C_WREADY & TRAN_DATA_C_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_DATA_C_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_DATA_C_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_DATA_C_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_DATA_C_AWVALID && TRAN_DATA_C_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_DATA_C_ARVALID && TRAN_DATA_C_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_DATA_C_WVALID && TRAN_DATA_C_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_DATA_C_WVALID && TRAN_DATA_C_WREADY && TRAN_DATA_C_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_DATA_C_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_DATA_C_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [DATA_C_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [DATA_C_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [DATA_C_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > DATA_C_mem_depth) begin
                $display ("C:/Users/anges/Documents/UIUC/ECE_527/ece527/mp4/lenet_conv1/lenet_accelerator/sim/verilog/AESL_axi_master_DATA_C.v: Write request address %d exceed AXI master DATA_C array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, DATA_C_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = DATA_C_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = DATA_C_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = DATA_C_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        3 : WDATA_tmp[j] = DATA_C_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : DATA_C_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : DATA_C_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : DATA_C_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            3 : DATA_C_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = DATA_C_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = DATA_C_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = DATA_C_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        3 : WDATA_tmp[j] = DATA_C_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : DATA_C_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : DATA_C_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : DATA_C_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            3 : DATA_C_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > DATA_C_mem_depth) begin
                $display ("C:/Users/anges/Documents/UIUC/ECE_527/ece527/mp4/lenet_conv1/lenet_accelerator/sim/verilog/AESL_axi_master_DATA_C.v: Read request address %d exceed AXI master DATA_C array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, DATA_C_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= DATA_C_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= DATA_C_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= DATA_C_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            3 : RDATA_tmp <= DATA_C_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_DATA_C_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= DATA_C_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= DATA_C_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= DATA_C_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            3 : RDATA_tmp <= DATA_C_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer DATA_C_bitwidth; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [DATA_C_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [DATA_C_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  DATA_C_bitwidth = DATA_C_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (DATA_C_bitwidth , factor);
  fp = $fopen(`TV_IN_DATA_C,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_DATA_C); 
      $finish; 
  end 
  token = read_token(fp); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      mem_tmp [DATA_C_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < 6 ; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : DATA_C_mem_0[i/factor] = mem_tmp;
                      1 : DATA_C_mem_1[i/factor] = mem_tmp;
                      2 : DATA_C_mem_2[i/factor] = mem_tmp;
                      3 : DATA_C_mem_3[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : DATA_C_mem_0[i] = mem_tmp;
                  1 : DATA_C_mem_1[i] = mem_tmp;
                  2 : DATA_C_mem_2[i] = mem_tmp;
                  3 : DATA_C_mem_3[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [DATA_C_DATA_BITWIDTH - 1: 0] = 0;
          end
