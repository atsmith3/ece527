...
if {[file isfile convolution1.autotvin.dat]} {
	file delete -force convolution1.autotvin.dat
}

if {[file isfile convolution1.autotvout.dat]} {
	file delete -force convolution1.autotvout.dat
}
