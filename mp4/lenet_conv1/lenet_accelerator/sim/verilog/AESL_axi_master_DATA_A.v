...
//------------------------Parameter----------------------
`define TV_IN_DATA_A "../tv/cdatafile/c.convolution1.autotvin_DATA_A.dat"
`define TV_OUT_DATA_A "../tv/rtldatafile/rtl.convolution1.autotvout_DATA_A.dat"
...
parameter DATA_A_C_DATA_BITWIDTH = 32'd 32;
parameter DATA_A_mem_depth = 32'd 1024;
...
output [32 - 1 : 0] TRAN_DATA_A_input_r;
input ready;
input done;
...
reg [DATA_A_DATA_BITWIDTH - 1 : 0] DATA_A_mem_3 [0: DATA_A_mem_depth - 1]; 
...
assign    TRAN_DATA_A_input_r = input_r;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > DATA_A_mem_depth) begin
                $display ("C:/Users/anges/Documents/UIUC/ECE_527/ece527/mp4/lenet_conv1/lenet_accelerator/sim/verilog/AESL_axi_master_DATA_A.v: Write request address %d exceed AXI master DATA_A array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, DATA_A_mem_depth); 
                $finish;
            end
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        ...
                                        3 : WDATA_tmp[j] = DATA_A_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            ...
                            3 : DATA_A_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        ...
                                        3 : WDATA_tmp[j] = DATA_A_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            ...
                            3 : DATA_A_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > DATA_A_mem_depth) begin
                $display ("C:/Users/anges/Documents/UIUC/ECE_527/ece527/mp4/lenet_conv1/lenet_accelerator/sim/verilog/AESL_axi_master_DATA_A.v: Read request address %d exceed AXI master DATA_A array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, DATA_A_mem_depth); 
                $finish;
            end
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            ...
                            3 : RDATA_tmp <= DATA_A_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            ...
                            3 : RDATA_tmp <= DATA_A_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      ...
                      3 : DATA_A_mem_3[i/factor] = mem_tmp;
