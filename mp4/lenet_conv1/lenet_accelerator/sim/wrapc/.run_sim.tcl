...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "convolution1.autotvin.dat"
	set constFileTvOut       "convolution1.autotvout.dat"
	set constFileHdlTvIn     "convolution1.autohdltvin.dat"
	set constFileHdlTvOut    "convolution1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
