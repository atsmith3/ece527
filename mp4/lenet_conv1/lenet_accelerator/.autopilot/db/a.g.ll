; ModuleID = 'C:/Users/anges/Documents/UIUC/ECE_527/ece527/mp4/lenet_conv1/lenet_accelerator/.autopilot/db/a.g.bc'
...
; <label>:176                                     ; preds = %173
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str13, i32 0, i32 0)) nounwind, !dbg !163 ; [debug line = 61:29]
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !165 ; [debug line = 62:1]
  store i32 0, i32* %j, align 4, !dbg !166        ; [debug line = 63:6]
  br label %177, !dbg !166                        ; [debug line = 63:6]

; <label>:177                                     ; preds = %203, %176
  %178 = load i32* %j, align 4, !dbg !166         ; [#uses=1 type=i32] [debug line = 63:6]
  %179 = icmp slt i32 %178, 28, !dbg !166         ; [#uses=1 type=i1] [debug line = 63:6]
  br i1 %179, label %180, label %206, !dbg !166   ; [debug line = 63:6]

; <label>:180                                     ; preds = %177
  store i32 0, i32* %k, align 4, !dbg !168        ; [debug line = 64:8]
  br label %181, !dbg !168                        ; [debug line = 64:8]

; <label>:181                                     ; preds = %199, %180
  %182 = load i32* %k, align 4, !dbg !168         ; [#uses=1 type=i32] [debug line = 64:8]
  %183 = icmp slt i32 %182, 28, !dbg !168         ; [#uses=1 type=i1] [debug line = 64:8]
  br i1 %183, label %184, label %202, !dbg !168   ; [debug line = 64:8]

; <label>:184                                     ; preds = %181
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str14, i32 0, i32 0)) nounwind, !dbg !171 ; [debug line = 64:29]
...
; <label>:199                                     ; preds = %184
  %200 = load i32* %k, align 4, !dbg !176         ; [#uses=1 type=i32] [debug line = 64:23]
  %201 = add nsw i32 %200, 1, !dbg !176           ; [#uses=1 type=i32] [debug line = 64:23]
  store i32 %201, i32* %k, align 4, !dbg !176     ; [debug line = 64:23]
  br label %181, !dbg !176                        ; [debug line = 64:23]

; <label>:202                                     ; preds = %181
  br label %203, !dbg !177                        ; [debug line = 68:3]

; <label>:203                                     ; preds = %202
  %204 = load i32* %j, align 4, !dbg !178         ; [#uses=1 type=i32] [debug line = 63:21]
  %205 = add nsw i32 %204, 1, !dbg !178           ; [#uses=1 type=i32] [debug line = 63:21]
  store i32 %205, i32* %j, align 4, !dbg !178     ; [debug line = 63:21]
  br label %177, !dbg !178                        ; [debug line = 63:21]

; <label>:206                                     ; preds = %177
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str13, i32 0, i32 0)) nounwind, !dbg !179 ; [debug line = 70:2]
...
!163 = metadata !{i32 61, i32 29, metadata !164, null}
!164 = metadata !{i32 786443, metadata !162, i32 61, i32 28, metadata !6, i32 24} ; [ DW_TAG_lexical_block ]
!165 = metadata !{i32 62, i32 1, metadata !164, null}
!166 = metadata !{i32 63, i32 6, metadata !167, null}
!167 = metadata !{i32 786443, metadata !164, i32 63, i32 2, metadata !6, i32 25} ; [ DW_TAG_lexical_block ]
!168 = metadata !{i32 64, i32 8, metadata !169, null}
!169 = metadata !{i32 786443, metadata !170, i32 64, i32 4, metadata !6, i32 27} ; [ DW_TAG_lexical_block ]
!170 = metadata !{i32 786443, metadata !167, i32 63, i32 26, metadata !6, i32 26} ; [ DW_TAG_lexical_block ]
!171 = metadata !{i32 64, i32 29, metadata !172, null}
!172 = metadata !{i32 786443, metadata !169, i32 64, i32 28, metadata !6, i32 28} ; [ DW_TAG_lexical_block ]
...
!176 = metadata !{i32 64, i32 23, metadata !169, null}
!177 = metadata !{i32 68, i32 3, metadata !170, null}
!178 = metadata !{i32 63, i32 21, metadata !167, null}
!179 = metadata !{i32 70, i32 2, metadata !164, null}
