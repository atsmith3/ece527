...
#ifndef __convolution5_fcmpEe0__HH__
#define __convolution5_fcmpEe0__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolution5_fcmpEe0) {
    ...
    SC_CTOR(convolution5_fcmpEe0):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
