...
CONFIG.NUM_SI {3} \
  ...
  # Create instance: packet_process_0, and set properties
  set block_name packet_process
  set block_cell_name packet_process_0
  if { [catch {set packet_process_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $packet_process_0 eq "" } {
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_net -net axis_data_fifo_0_m_axis_tdata [get_bd_pins axis_data_fifo_0/m_axis_tdata] [get_bd_pins packet_process_0/in_port]
  ...
  connect_bd_net -net packet_process_0_out_port [get_bd_pins axi_dma_0/s_axis_s2mm_tdata] [get_bd_pins packet_process_0/out_port]
