...
################################################################
# This is a generated script based on design: mp1a_hardware
#
...
# source mp1a_hardware_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DISPLAY_BUTTON [ create_bd_port -dir I DISPLAY_BUTTON ]
  set LED_INIT [ create_bd_port -dir O LED_INIT ]
  set LED_READY [ create_bd_port -dir O LED_READY ]
  set OLED_CONT_RST [ create_bd_port -dir I OLED_CONT_RST ]
...
CONFIG.use_bram_block {Stand_Alone} \
  ...
  set block_name oled_ip
  set block_cell_name oled_ip_0
  if { [catch {set oled_ip_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
...
CONFIG.NUM_MI {3} \
  ...
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins blk_mem_gen_0/douta] [get_bd_pins oled_ip_0/BRAM_DATA]
  connect_bd_net -net oled_ip_0_BRAM_ADDR [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins oled_ip_0/BRAM_ADDR]
  connect_bd_net -net oled_ip_0_BRAM_CLK [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins oled_ip_0/BRAM_CLK]
  connect_bd_net -net oled_ip_0_DC [get_bd_ports OLED_DC] [get_bd_pins oled_ip_0/DC]
  connect_bd_net -net oled_ip_0_LED_INIT [get_bd_ports LED_INIT] [get_bd_pins oled_ip_0/LED_INIT]
  connect_bd_net -net oled_ip_0_LED_READY [get_bd_ports LED_READY] [get_bd_pins oled_ip_0/LED_READY]
