...
HD_PWD='/home/andrew/ece527/mp2/mp2a.runs/mp1a_hardware_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mp1a_hardware_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mp1a_hardware_xbar_0.tcl
